...
export const api_coord = (suradnice) => `${BASE_URL}data/2.5/onecall?lat=${suradnice.lat}&lon=${suradnice.lon}&exclude=minutely,hourly&appid=${API_KEY}&units=metric&lang=sk`
